...
st.image("titanic.png", caption="El Titanic navegaba desde Southampton, Inglaterra, hasta Nueva York en Estados Unidos.")
...
classifier = DecisionTreeClassifier(max_depth=3, criterion='gini', min_samples_leaf=25, max_features=5, random_state=1614372)
classifier.fit(X, Y)
